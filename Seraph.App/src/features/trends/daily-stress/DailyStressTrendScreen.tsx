...
type Props = NativeStackScreenProps<HomeStackParamList, 'TrendDailyStress'>;

const COLOR = theme.colors.recovery;

export const DailyStressTrendScreen: React.FC<Props> = ({ route }) => {
    ...
    <View style={[s.container, { paddingTop: insets.top + 48 }]}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={s.scrollContent}>
        ...
        <View style={sectionStyles.container}>
          {summary && <TrendSummaryRow summary={summary} color={COLOR} unit="" fmt={fmtInteger} />}
          {isLoading ? (
