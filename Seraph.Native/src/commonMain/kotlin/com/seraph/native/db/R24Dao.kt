...
class R24Dao(
    ...
    fun queryByDate(date: String) = db.r24DbQueries.queryR24ByDate(date).executeAsList()
    ...
    fun deleteOlderThan(cutoffMs: Long) = db.r24DbQueries.deleteR24OlderThan(cutoffMs)
